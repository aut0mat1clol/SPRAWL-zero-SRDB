# ![Random Weapons Chest](../Images/RandomWeapons.png)
...
| 10 | Tier 4 - Wulei Arc-A (Rifle) |
| 11 | Tier 4 - Kurogane HMG-7 (Rifle) |
| 12 | Tier 5 - Hitokiri (Katana) |
| 13 | Tier 4 - Leigong AC-9 (Energy Weapon) |
| 14 | Tier 3 - Namazu Riot-V (Shotgun) |
| 15 | Tier 4 - Saito 50 BMG (Sniper Rifle) |
| 16 | Tier 3 - Vulcan (SMG) |
...
The first weapon you're allowed to get is Mitsurugi F18, since on ticks 1 and 2 you're unable to use your hands. For a speedrun, especially for the Inbounds category, Locust is the thing you want. So, you just need to press use on the weapon from the middle/end of the previous tick (in our case, Mitsurugi F18), because the animation lasts about one chest tick — and that's it, you got it!
